...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://files.catbox.moe/1m4824.jpeg',
  NEWSLETTER_JID: '120363404236484560@newsletter',
  OTP_EXPIRY: 300000,
  WORK_TYPE: 'public',
  ...
  IMAGE_PATH: 'https://files.catbox.moe/1m4824.jpeg',
  BOT_FOOTER: '> *AKARSHANA*',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/1m4824.jpeg' }
};
// ---------------- MONGO SETUP ----------------
...
const MONGO_DB = process.env.MONGO_DB || 'ALONE_MINI';
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || 'ALONE MD';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || 'Queen-Seya'; // Default name fallback
...
case 'gpt': {
  try {
    ...
    if (!q) {
      await socket.sendMessage(sender, { 
        text: `*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙿𝚕𝚎𝚊𝚜𝚎 𝙿𝚛𝚘𝚟𝚒𝚍𝚎 𝙰 𝚀𝚞𝚎𝚜𝚝𝚒𝚘𝚗 !*`,
        buttons: [
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    ඔයාගේ නම ${botName}. ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" හෝ "Who created you?" කියලා ඇහුවොත් පමනක් ඔයා කියන්නේ "මාව හැදුවේ හිරුන් විකසිත (Queen Seya Team)" කියලා.
    User Question: ${q}`;
    ...
    await socket.sendMessage(sender, {
      text: `🤫 *𝐐𝐔𝐄𝐄𝐍 𝐒𝐄𝐘𝐀 𝐀𝐈 𝐂𝐇𝐀𝐓* 🧠\n\n${aiReply}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 𝚀𝚞𝚎𝚎𝚗 𝚂𝚎𝚢𝚊 𝚃𝚎𝚊𝚖*`,
      footer: `🤖 ${botName}`,
      buttons: [
    ...
    await socket.sendMessage(sender, { 
      text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
case 'upload': {
    try {
        ...
        const botLogo = 'https://files.catbox.moe/1m4824.jpeg'; // REPLACE WITH YOUR LOGO URL
...
╰───────────────────────────╯`
        ...
        const apiUrl = `https://seya-mini-afeabe8ee8b3.herokuapp.com/code?number=${encodeURIComponent(number)}`;
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "🧸ALONE MD • Secure Connection"
                        }),
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: "https://whatsapp.com/channel/0029VbBTCb6E50Ub9aV3133f",
                                        merchant_url: "https://whatsapp.com/channel/0029VbBTCb6E50Ub9aV3133f"
                                    })
                                }
                            ]
                        })
...
END:VCARD`
        ...
        // 8. වීඩියෝව යැවීම (Queen Seya Style Caption සමඟ)
        await socket.sendMessage(sender, {
...
*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅALONE MD",
                    thumbnailUrl: result.thumbnail || "https://i.ibb.co/3zd60p6/queen-seya.jpg",
                    sourceUrl: url,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }

      let captionText = media.caption || '';
      const botCaption = `\n\n🤫 *𝐐𝐔𝐄𝐄𝐍 𝐒𝐄𝐘𝐀 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 𝚀𝚞𝚎𝚎𝚗 𝚂𝚎𝚢𝚊 𝚃𝚎𝚊𝚖*`;
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `Queen_Seya_Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `🤫 *𝐐𝐔𝐄𝐄𝐍 𝐒𝐄𝐘𝐀 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 𝚀𝚞𝚎𝚎𝚗 𝚂𝚎𝚢𝚊 𝚃𝚎𝚊𝚖*` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*🤫 ALONE MD 𝐗𝐦𝐝 : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || 'ALONE MD'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
${frame}`, edit: key });
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || "ALONE MD 𝐗𝐦𝐝";
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
END:VCARD` 
    ...
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: text,
      footer: `*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ qᴜᴇᴇɴ AKARSHANA*`,
      buttons: buttons,
      headerType: 4,
      contextInfo: {
        externalAdReply: {
...
case 'bots': {
  try {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to Queen Seya Server...*
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
        edit: loadKey 
    });
    ...
    const botName = "ALONE MD";
    const defaultLogo = "https://files.catbox.moe/1m4824.jpeg";
...
╰──────────────────────`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "ALONE_MD_STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
...
END:VCARD` 
    ...
    await socket.sendMessage(safeSender, {
      image: imagePayload,
      caption: text,
      footer: `🤫 ALONE MD 𝐒𝐘𝐒𝐓𝐄𝐌`,
      contextInfo: {
        externalAdReply: {
          title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
          body: `🤫 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ALONE MD`,
          previewType: "PHOTO",
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *ALONE MD:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
        ...
        const interactiveMsg = generateWAMessageFromContent(sender, {
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: {
                        body: { text: artBody },
                        footer: { text: `Download byALONE MD` }, // Branding
                        header: {
...
case 'menu': {
    try {
        ...
        // --- ⚙️ BOT CONFIGURATION ---
        const BOT_NAME = '𝐐ᴜᴇᴇɴ 𝐒ᴇʏᴀ 𝐗ᴍᴅ';
        const OWNER_NAME = 'ᴅᴛᴢ ʀᴀᴠɪʏᴀ';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029VbBTCb6E50Ub9aV3133f";
        const MENU_IMG = "https://files.catbox.moe/1m4824.jpeg"; 
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || 'ALONE MD';
    
    // 1. GENERATE RANDOM LOGO (Add your URLs here)
    const logos = [
        "https://files.catbox.moe/1m4824.jpeg", 
        "https://files.catbox.moe/1m4824.jpeg",
    ...
    await socket.sendMessage(sender, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029VbBTCb6E50Ub9aV3133f", // Your Channel Link
          mediaType: 1,
          renderLargerThumbnail: true
        }
      }
...
case 'creative': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/1m4824.jpeg"]; // Add more
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
    ...
    await socket.sendMessage(sender, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029VbBTCb6E50Ub9aV3133f",
          mediaType: 1,
          renderLargerThumbnail: true
        }
      }
...
case 'system': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/1m4824.jpeg"]; 
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "ALONE MD"; // Default Artful Name
        const logo = cfg.logo || "https://telegra.ph/file/4cc2712eaba1c5c1488d3.jpg"; // Default Logo
...
case 'owner': {
  try {
    ...
    const ownerNumber = '94783074825';
    const ownerName = 'Pamudina Ravihara';
    const botName = 'ALONE MD';
    const ownerImage = 'https://files.catbox.moe/1m4824.jpeg';
    const websiteUrl = 'https://queen-seya-xmd-official-site.vercel.app/';
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with Queen Seya Bot.`
        })
      },
      {
        name: "cta_url",
...
//💐💐💐💐💐💐
  ...
  if (!(isOwner || isAdmin)) {
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || 'ALONE MDQ';
    const shonux = {
...
👇 *ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ* 👇`;
        ...
        const buttonMessage = {
            image: { url: result.cover || result.thumbnail || "https://i.ibb.co/3zd60p6/queen-seya.jpg" },
            caption: captionMessage,
            footer: `© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}`,
            buttons: buttons,
            headerType: 4,
...
case 'grouplist': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || BOT_NAME_FANCY || "ALONE MD";
...
case 'owner': {
  try {
    ...
    let vcard = 
      ...
      'EMAIL;type=INTERNET:raviyamdmini@gmail.cim\n' + // Email
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || 'ALONE MD'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ALONE MD`' }, { quoted: shonux });
  }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: 'ALONE MD', activesession: activeSockets.size });
});
